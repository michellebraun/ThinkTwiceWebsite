    ...
    <div>
      ...
      <div class='row'>
        ...
        <div class='twoColumn'>
          ...
          <p className='bodyText'>The material is reused from a previous items. A pass for this category is an indication the material is at least 20% recycled.</p>
          <p className='organicMat'>Organic Material</p>
          <p className='bodyText'>A list of organic material is compared with the material used in the product. A pass for this category is the all the material being at least 95% organic.</p>
