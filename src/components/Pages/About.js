...
function About() {
  ...
  return (
    <div>
      ...
      <p className='bodyText'>From our research, consumers have an interest in purchasing more sustainably but they don't know where to find the information. Even if they find information, it can be misleading or lack transparency. In order to take better care of our planet and people, we need to take a stand and educate consumers on sustainability.</p>
