...
function About() {
  ...
  return (
    <div>
      ...
      <p className='bodyText'>In addition, the concept of fast fashion has a significant amount of unethical practises. How do you think they can sell dirt cheap clothes at such a large scale?!</p>
